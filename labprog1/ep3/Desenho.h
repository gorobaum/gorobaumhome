...
Rect criaRect(int base, int altura); /*Cria um Rect com os parametros passados.*/
int getBase(Rect r);                 /*Retorna o valor da base do Rect passado.*/
int getAltura(Rect r);               /*Retorna o valor da Altura do Rect passado.*/
